...
RSpec.describe 'availabilities/show.html.erb', type: :view do
  let(:availability) { FactoryBot.create(:availability, start_time: Time.zone.now + 1.hour, end_time: Time.zone.now + 2.hour, filled_status: 'Available') }
